 ...
 _.-'\"           \"`-.`-.\" "
        ...
        return (
            <React.Fragment>
                ...
                <p>
                    What a key part of my life this has become! It all started with an innocent dabble into HTML eleven years ago, and little did I expect to be dragged into the surprisingly addictive world of problems (hopefully with solutions), sleepless nights (*bugs*), and, most importantly, stack overflow. But I love it.
                </p>
                <p>
                    Key areas of interest: <br />
                    &nbsp;&nbsp;&nbsp;&nbsp; // Graphics programming (OpenGL, Pathtracing) <br />
                    &nbsp;&nbsp;&nbsp;&nbsp; // Security <br />
                    &nbsp;&nbsp;&nbsp;&nbsp; // AI <br />
                    &nbsp;&nbsp;&nbsp;&nbsp; // Learning! <br />
                </p>
